...
public class JdbcTimeEntryRepositoryTest {
    ...
    public void createInsertsATimeEntryRecord() throws Exception {
        TimeEntry newTimeEntry = new TimeEntry(123L, 321L, LocalDate.parse("2017-01-09"), 8L);
    ...
    public void updateReturnsTheUpdatedRecord() throws Exception {
        ...
        TimeEntry timeEntryUpdates = new TimeEntry(456L, 987L, LocalDate.parse("2017-01-10"), 10L);
    ...
    public void updateUpdatesTheRecord() throws Exception {
        ...
        TimeEntry updatedTimeEntry = new TimeEntry(456L, 322L, LocalDate.parse("2017-01-10"), 10L);
